...
```{r, fig.width=6, fig.height=3, fig.cap="The density of juvenile Chinook salmon fork length as it relates to water temperature at sample sites in the San Francisco Estuary from 1976 to 2021."}
